...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_ACCEL_ECDSA_SECP_R1_256_SHA_1, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_ACCEL_ECDSA_SECP_R1_256_SHA_224, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_ACCEL_ECDSA_SECP_R1_256_SHA_256, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_CC3XX_GCM_AES, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_CC3XX_AEAD_DRIVER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_CC3XX_ECDSA_SECP_R1_256, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_CC3XX_ASYMMETRIC_SIGNATURE_DRIVER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_CRYPTO_NV_SEED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_PARTITION_SIZE_TFM_SRAM, 0x30000);
