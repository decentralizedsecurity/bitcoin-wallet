...
struct _isr_table_entry __sw_isr_table _sw_isr_table[69] = {
	...
	{(const void *)0x4670d, (ISR)0x49d5b}, /* 42 */
	...
	{(const void *)0x46671, (ISR)0x49d5b}, /* 47 */
